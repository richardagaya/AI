          ...
          <div className="hidden items-center gap-1 md:flex">
            {links.map((l) => (
              <a
                ...
                href={l.href}
                className={cn(
                  "rounded-full px-4 py-2 text-[0.82rem] transition-colors hover:text-frost",
                  pathname === l.href ? "text-frost" : "text-frost-dim",
                )}
              >
                {l.label}
              </a>
            ...
            <div className="flex flex-col gap-1">
              {links.map((l, i) => (
                <motion.a
                  ...
                  className={cn(
                    "border-b border-line/60 py-5 text-2xl font-semibold tracking-[-0.03em]",
